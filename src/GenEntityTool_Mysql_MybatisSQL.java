...
public class GenEntityTool_Mysql_MybatisSQL {
    public static void main(String[] args) {
        // MYSQL 数据库连接驱动信息
        String databaseName = "house";// mysql数据库名称
        String user = "root"; // 数据库连接用户名
        String password = "root"; // 数据库连接密码
        String tableName = "liuyan"; // 要生成实体类的数据库表名（数据库中表名称）
        String entityName = "Liuyan";// 要生成实体类的表名 【Java类名】
    ...
    //  ## 代表字段注释  @@ 代表字段名
    String form = "<div class=\"layui-form-item\"><label class=\"layui-form-label\">##</label><div class=\"layui-input-block\"><input type=\"text\" id=\"@@\" value=\"${objBean.@@}\" name=\"@@\" required lay-verify=\"required\"                   placeholder=\"请输入##\" autocomplete=\"off\" class=\"layui-input\" style=\"width: 500px;\"></div></div>";
